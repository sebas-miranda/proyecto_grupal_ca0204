...
1.  **Las variables clave se transforman en cuantitativas.** Aunque la base original es categórica, el análisis se realiza sobre frecuencias y tasas de delitos (números reales) y sobre indicadores porcentuales de pobreza y desempleo, que también son variables continuas. Esto hace que Pearson sea apropiado para medir su asociación.

2.  **Interesa específicamente la relación lineal.** La pregunta de investigación busca saber si los cantones con mayor pobreza o desempleo tienden a presentar más delitos. Es decir, se quiere saber si, conforme suben los indicadores socioeconómicos negativos, aumentan también las tasas de criminalidad. Esta idea de “sube–sube” o “sube–baja” es justamente lo que captura el coeficiente de Pearson.

3.  **Tamaño muestral grande y datos agregados.** Al trabajar con los 82 cantones y varios años, el número de observaciones es suficiente para que las estimaciones de Pearson sean estables. Además, la limpieza previa de datos, el tratamiento de valores faltantes y la winsorización de outliers reducen el impacto de valores extremos que podrían distorsionar la correlación.
...
5.  **Posibilidad de comparar por género.** Al calcular r por separado para hombres y mujeres, se puede evaluar si la relación entre pobreza/desempleo y criminalidad es más fuerte en uno u otro género, respondiendo directamente al enfoque de género del proyecto.
